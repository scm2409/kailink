package org.box44.kailink.domain.speech

import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.emptyFlow

/**
 * Speech input seam (STT) — see docs/features/sprache.md.
 * Concrete implementations belong in `data/`, never in UI/logic (G5).
 */
...
data class SpeechUtterance(
    val text: String,
    /** true = final recognition result */
    val isFinal: Boolean,
)

/** Speech output seam (TTS) — see docs/features/sprache.md. */
...
/** Documented no-op implementation (PoC default wiring). */
